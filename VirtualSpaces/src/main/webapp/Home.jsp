        ...
        <div class="container">
            <div class="header">
                ...
                <div class="head-links">
                    <a href="#">About Us</a>
                    <a href="#">Features</a>
                    <a href="https://accounts.google.com/o/oauth2/auth?scope=profile%20email&redirect_uri=http://localhost:8080/VirtualSpaces/LoginGoogleHandler&response_type=code&client_id=yput-key&approval_prompt=force">Sign Up</a>
                </div>
            </div>
            ...
            <div class="body">
                ...
                <div class="getstarted-btn">
                    <a href="https://accounts.google.com/o/oauth2/auth?scope=profile%20email&redirect_uri=http://localhost:8080/VirtualSpaces/LoginGoogleHandler&response_type=code&client_id=yput-key&approval_prompt=force" id="btn-login">Get Started</a>
                </div>
            </div>
